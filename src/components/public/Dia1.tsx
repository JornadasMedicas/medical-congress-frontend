...
const rows = [
    ...
    createData('11:00 AM - 12:00 PM', '"DENGUE CAMBIOS IMPORTANTES EN SU EVOLUCIÓN Y MANEJO"', '', 'bold'),
    ...
    createData('', ' DRA. NAIDE VELES BLANCO MEDICO NEONATOLOGO PEDIATRA DEL CAE', '', ''),
    //MÓDULO ENFERMERÍA
